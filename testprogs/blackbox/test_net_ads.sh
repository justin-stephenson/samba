...
testit "ldb check for existence of machine account" $ldbsearch -H $PREFIX/$ENVNAME/private/sam.ldb -s base -b "cn=$HOSTNAME,$computers_ldb_ou" || failed=`expr $failed + 1`
